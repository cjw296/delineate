...
class TestDownloadFile:
    ...
    def test_empty_display_name(self, httpx_mock, tmp_path):  # type: ignore[no-untyped-def]
...
class TestDownloadAll:
    def test_basic(self, httpx_mock, tmp_path):  # type: ignore[no-untyped-def]
    ...
    def test_dedup(self, httpx_mock, tmp_path):  # type: ignore[no-untyped-def]
        httpx_mock.add_response(content=b"data")
        client = LinearClient(api_key="lin_api_test")
        urls = [
            ("img.png", "https://uploads.linear.app/ws/u1/aaaa1111"),
